...
verify_state() {
  ...
  [[ -f "$PROFILE_DEST_FIXED" && ! -L "$PROFILE_DEST_FIXED" ]] || fail "$EXIT_VERIFY" 'approved profile artifact missing or symlinked'
