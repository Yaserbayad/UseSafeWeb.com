...
| Server topology | Web/application and AdGuard/DNS run on separate owner-provided Azure VMs; one AdGuard node initially; direct host installation is preferred and Docker/container orchestration is not a default requirement. |
